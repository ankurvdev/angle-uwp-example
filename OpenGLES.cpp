...
OpenGLES::OpenGLES() : mEglConfig(nullptr), mEglDisplay(EGL_NO_DISPLAY), mEglContext(EGL_NO_CONTEXT)
{
    Initialize();
}
...
EGLSurface OpenGLES::CreateSurface(winrt::Windows::UI::Xaml::Controls::SwapChainPanel& visual)
{
    ...
    EGLSurface surface = eglCreateWindowSurface(mEglDisplay, mEglConfig, static_cast<EGLNativeWindowType>(winrt::get_abi(visual)), nullptr);
